...
<body>
    <div class="container">
        <header><i class="fa fa-user"></i> Update </header><br><span>Go back to profile<a href="index.jsp" style="color:orange; text-decoration:none;" > Click</a></span>
          <% if(rs.next())
   			{ %>
        <h3>Welcome, <%=rs.getString("NAME")%>!</h3>
