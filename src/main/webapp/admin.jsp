            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="index.jsp?EMAIL=<%=email%>" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                     ...
                     <a href="project.jsp" class="nav-item nav-link"><i class="fa fa-chart-area me-2"></i>Projects</a>
                     ...
                     <a href="add-emp.jsp" class="nav-item nav-link"><i class="fa fa-phone me-2"></i>Add User</a>
                    </div> 
                </div>
            </nav>
        </div>
